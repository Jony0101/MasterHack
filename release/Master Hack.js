...
function getTarget() {
    try {
        ...
        //window.target = game.getStriker().getPrefercyanTarget_0(enemyID).components_0.array[5].tankPhysicsComponent_tczrao$_0.interpolatedPosition
...
hackWindow.style.outline = "3px solid cyan"
//Object.assign():
Object.assign(hackWindow.style, hackWindow_style);
root.appendChild(hackWindow)

title = document.createElement("span")
title.innerText = "MasterHack"
hackWindow.appendChild(title)

ccyans = document.createElement("span")
ccyans.innerText = " Jony"
hackWindow.appendChild(ccyans)
...
Object.assign(ccyans.style, ccyans_style)
...
Notilt.innerText = "Wall Hack Stable:"
Autoclicker.innerText = "[Soon]"
Autoheal.innerText = "[Soon]"
BoxTP.innerText = "[Soon]"
SimpleTP.innerText = "[Soon]:"
rapidUpdate.innerText = "[Soon]"
Speedhack.innerText = "[Soon]"
Ghack.innerText = "[Soon]"
safeM.innerText = "[Soon]"
...
applyButtons(airwalkBtn, NoKnockbackBtn, IgnoreTexturesBtn, MineHackBtn, GoldTPBtn, FlagTPBtn, randomBtn)
...
applyLabels(Airwalk, NoKnockback, IgnoreTextures, Minehack, GoldTP, flagTP, randomTP)

Airwalk.innerText = "Jump Hack [J/K]:"
randomTP.innerText = "Anti Aim:"
flagTP.innerText = "Flag Teleport [N]:"
GoldTP.innerText = "GoldBox Teleport [T]:"
Minehack.innerText = "Remove Mines:"
NoKnockback.innerText = "Jump Hack Stable:"
IgnoreTextures.innerText = "Wall Hack:"
...
Sclose.innerText = "Toggle UI [Insert/Numpad0]"
SclickA.innerText = "[Soon]"
SclickB.innerText = "[Soon]"
SclickJ.innerText = "[Soon]"
SautoShot.innerText = "[Soon]"
...
freezeTanks.innerText = "[Soon]"
noStun.innerText = "[Soon]"
decluster.innerText = "[Soon]"
playerMines.innerText = "[Soon]"
ohk.innerText = "[Soon]"
aimbot.innerText = "Striker Vertical:"
tpr.innerText = "[Soon]"

applyLabels(aimbot, freezeTanks, noStun, decluster, playerMines, ohk, tpr)
applyButtons(aimbotBtn ,freezeTanksBtn, noStunBtn, declusterBtn, playerMinesBtn, ohkBtn, tprBtn)
...
minusButton.style.backgroundColor = "cyan"
...
clickMinusButton.style.backgroundColor = "cyan"
...
fastClicker.innerText = "[Soon]:"
targetMode.innerText = "[Soon]:"
...
setInterval(function() {
    try {
        speedText.innerText = `[Soon] [${slider.value}]:`
    } catch (error) {}
}, 100)
...
DeathSpawn.innerText = "Knockback"
noLaser.innerText = "[Soon]"
...
setInterval(function() {
    try {
        accText.innerText = `[Soon] [${slider2.value}]:`
    } catch (error) {}
}, 100)
...
setInterval(function() {
    try {
        tpText.innerText = `KnockBack [${slider3.value}]:`
    } catch (error) {}
}, 100)
...
setInterval(function() {
    try {
        clickText.innerText = `[Soon] [${slider4.value}]:`
    } catch (error) {}
}, 100)
...
setInterval(function() {
    try {
        minerText.innerText = `[Soon] [${slider6.value}] Ms:`
    } catch (error) {}
}, 100)
